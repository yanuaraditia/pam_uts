        ...
        apiCall.enqueue(new Callback<DetailModel>() {
            ...
            public void onResponse(Call<DetailModel> call, Response<DetailModel> response) {
                if (response.isSuccessful()) {
                    ...
                    tv_budget.setText("USD " + NumberFormat.getIntegerInstance().format(item.getBudget()));
                    tv_revenue.setText("USD " + NumberFormat.getIntegerInstance().format(item.getRevenue()));
